...
public:
  ...
  using ImplicitLipidIntegralParameters2D =
      ImplicitLipidProbabilityService::IntegralParameters2D;
  using ImplicitLipidBindingProbability2DResult =
      ImplicitLipidProbabilityService::BindingProbability2DResult;
  ...
  using CompartmentTransmissionParameters =
      ImplicitLipidProbabilityService::CompartmentTransmissionParameters;
  ...
  static CompartmentTransmissionParameters CompartmentTransmissionSetup(
    ...
    return ImplicitLipidProbabilityService::CompartmentTransmissionSetup(
        association_rate, binding_radius, diffusion_total, time,
        compartment_radius, site_density);
  }
  ...
  static double ImplicitLipidDissociationProbability2D(
    ...
    return ImplicitLipidProbabilityService::DissociationProbability2D(
  ...
  static double ImplicitLipidDissociationProbability3D(
    ...
    return ImplicitLipidProbabilityService::DissociationProbability3D(
        time, diffusion_total, binding_radius, association_rate,
        dissociation_rate);
  }
  ...
  static double ImplicitLipidBindingProbability3D(double separation,
                                                  ...
                                                  double binding_radius,
                                                  double association_rate) {
    return ImplicitLipidProbabilityService::BindingProbability3D(
        separation, time, diffusion_total, binding_radius, association_rate);
  }
  ...
  static double CompartmentEntryProbability(double distance_to_surface,
                                            ...
                                            double site_density) {
    return ImplicitLipidProbabilityService::CompartmentEntryProbability(
        distance_to_surface, time, diffusion_total, binding_radius,
        association_rate, compartment_radius, site_density);
  }
  ...
  static double CompartmentExitProbability(double distance_to_surface,
                                           ...
                                           double compartment_radius,
                                           double site_density) {
    return ImplicitLipidProbabilityService::CompartmentExitProbability(
        distance_to_surface, time, diffusion_total, binding_radius,
        association_rate, compartment_radius, site_density);
  }
  ...
  static double ImplicitLipidIntegralKernel2D(double u, double binding_radius,
                                              ...
                                              double time) {
    return ImplicitLipidProbabilityService::IntegralKernel2D(
        u, binding_radius, diffusion_total, association_rate, reaction_radius,
        time);
  }

  static double ImplicitLipidIntegralKernel2DCallback(double u,
                                                      void* parameter) {
    return ImplicitLipidProbabilityService::IntegralKernel2DCallback(
        u, parameter);
  }
  ...
  static double IntegrateImplicitLipidKernel2D(
    ...
    return ImplicitLipidProbabilityService::IntegrateKernel2D(
        binding_radius, diffusion_total, association_rate, reaction_radius,
        time);
  }
  ...
  static double ImplicitLipidBlockDistance2D(
      ...
      double association_rate, double dissociation_rate, int solution_count,
      int lipid_count, double membrane_area) {
    return ImplicitLipidProbabilityService::BlockDistance2D(
        time, diffusion_total, binding_radius, association_rate,
        dissociation_rate, solution_count, lipid_count, membrane_area);
  }
  ...
  ImplicitLipidBindingProbability2D(
    ...
    return ImplicitLipidProbabilityService::BindingProbability2D(
        time, diffusion_total, binding_radius, association_rate,
        dissociation_rate, solution_count, lipid_count, membrane_area,
        reaction_radius);
  }
