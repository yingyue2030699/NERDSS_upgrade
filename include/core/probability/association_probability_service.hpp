/*! \file association_probability_service.hpp
 * \brief Pure association and rebinding probability kernels.
 */
...
class AssociationProbabilityService {
public:
  ...
  static double RebindingProbabilityRatio3D(
      double current_radius, double initial_radius, double time,
      double diffusion_total, double binding_radius, double alpha,
      double previous_survival, double tolerance) {
  ...
  static double RebindingProbabilityRatio1D(
      double current_radius, double initial_radius, double time,
      double diffusion_total, double binding_radius, double ka,
